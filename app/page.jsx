...
ברקע - גופני: [מחלות, טיפולים, מעקבים]. פסיכופתולוגיה משפחתית: [אם יש]. שימוש בחומרים: [עבר והווה].

מחלה נוכחית - [פסקה מפורטת: התפתחות, ציטוטים בגרשיים, תשאול ייעודי לפי הסינדרום - מאניה/דיכאון/פסיכוזה/OCD/PTSD/חרדה.] שולל [תסמינים] בעבר ובהווה. אובדנות - [בעבר ובהווה, תכנית, אמצעי, ניסיונות].
...
חוסרים לבירור: [רשימה בשורות נפרדות.]`;
...
תרופתי - [פסקה קצרה וקולעת. לדוגמה: לשקול מיצוי הטיפול הנוכחי ל___ (לאימות), או אוגמנטציה עם ___ שיסייע גם ב___. אם אין תגובה, לשקול מעבר ל___. לנטר ___.] 
